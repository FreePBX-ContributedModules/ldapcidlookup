...
$dispnum = "ldapcidlookup"; //used for switch on config.php
	...
	<tr>
		...
		<td>
			<select id="sourcetype" name="sourcetype" onChange="javascript:displaySourceParameters(this, this.selectedIndex)">
				...
				<option value="ldap" <?php echo ($thisItem['sourcetype'] == 'ldap' ? 'selected' : '')?>>LDAP</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			<div id="ldap" style="display: none">
				<table cellpadding="2" cellspacing="0" width="100%">
					<tr><td colspan="2"><h5><?php echo _("LDAP") ?><hr></h5></td></tr>
				
					<tr>
						<td width="50%"><a href="#" class="info"><?php echo _("Host:")?><span><?php echo _("LDAP Host")?></span></a></td>
						<td><input type="text" name="ldap_host" value="<?php echo (isset($thisItem['ldap_host']) ? $thisItem['ldap_host'] : ''); ?>"></td>
					</tr>
					<tr>
						<td><a href="#" class="info"><?php echo _("Username:")?><span><?php echo _("LDAP Username")?></span></a></td>
						<td><input type="text" name="ldap_username" value="<?php echo (isset($thisItem['ldap_username']) ? $thisItem['ldap_username'] : ''); ?>"></td>
					</tr>
					<tr>
						<td><a href="#" class="info"><?php echo _("Password:")?><span><?php echo _("LDAP Password")?></span></a></td>
						<td><input type="text" name="ldap_password" value="<?php echo (isset($thisItem['ldap_password']) ? $thisItem['ldap_password'] : ''); ?>"></td>
					</tr>
					<tr>
						<td><a href="#" class="info"><?php echo _("Base DN:")?><span><?php echo _("LDAP Base Distinguished Name, for example DC=freepbx,DC=com")?></span></a></td>
						<td><input type="text" name="ldap_base" value="<?php echo (isset($thisItem['ldap_base']) ? $thisItem['ldap_base'] : ''); ?>"></td>
					</tr>
					<tr>
						<td><a href="#" class="info"><?php echo _("Area Code Prefix:")?><span><?php echo _("Prefix for your local area code")?></span></a></td>
						<td><input type="text" name="ldap_prefix" value="<?php echo (isset($thisItem['ldap_prefix']) ? $thisItem['ldap_prefix'] : ''); ?>"></td>
					</tr>
					<tr>
						<td><a href="#" class="info"><?php echo _("Number Format:")?><span><?php echo _("Reformat phone number before lookup. Use 'X' for number placement.  For example (XXX) XXX-XXXX or (XX) XXXX-XXXX depending on your country, and the format of numbers in your ldap repository.")?></span></a></td>
						<td><input type="text" name="ldap_format" value="<?php echo (isset($thisItem['ldap_format']) ? $thisItem['ldap_format'] : ''); ?>"></td>
					</tr>
				</table>
			</div>
		</td>
...
function displaySourceParameters(sourcetypeSelect, key) {
	if (sourcetypeSelect.options[key].value == 'http') {
		...
		document.getElementById('ldap').style.display = 'none';
	} else if (sourcetypeSelect.options[key].value == 'ldap') {
		document.getElementById('http').style.display = 'none';
		document.getElementById('mysql').style.display = 'none';
		document.getElementById('sugarcrm').style.display = 'none';
